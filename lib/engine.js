...
class Engine extends Component {
	...
	startup(callback) {
		// start service
		var self = this;
		this.logDebug(3, "OpsRocket Satellite v" + this.server.__version + " starting up" );
		...
		this.request = new Request( "OpsRocket Satellite v" + this.server.__version );
	...
	shutdown(callback) {
		// stop service
		this.logDebug(3, "Shutting down OpsRocket Satellite");
		this.abortAllJobs();
